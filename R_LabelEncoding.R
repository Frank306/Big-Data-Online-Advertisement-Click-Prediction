...
TrainData <- fread("Train-000.csv") # five million rows for advanced models
...
# 3. Adding interaction between features in the dataset
...
# 5. Label-encoding categorical variables that advanced models can handle well
for(i in c(1,3:55)){
